...
const DB_COLUMNS: Record<AppTable, readonly string[]> = {
  events: ['id', 'title', 'event_type', 'event_date', 'start_time', 'end_time', 'location', 'color', 'task_id', 'is_completed', 'profile', 'repeat', 'repeat_days', 'repeat_until', 'created_at', 'updated_at'],
